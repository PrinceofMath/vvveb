...
$_pagination_count = $this->posts[$_posts_idx]['count'];
$_pagination_limit = isset($this->posts[$_posts_idx]['limit'])? $this->posts[$_posts_idx]['limit'] : 5;
?>

[data-v-component-posts] [data-v-category] = <?php $_category = current($this->posts[$_posts_idx]['posts']);echo $_category['category'];?>
[data-v-component-posts] [data-v-manufacturer] = <?php $_manufacturer = current($this->posts[$_posts_idx]['posts']);echo $_manufacturer['manufacturer'];?>


//$post = [data-v-component-posts]  [data-v-post]

[data-v-component-posts]  [data-v-post]|before = <?php 
if(isset($this->posts) && is_array($this->posts[$_posts_idx]['posts'])) 
{
	//$pagination = $this->posts[$_posts_idx]['pagination'];
	foreach ($this->posts[$_posts_idx]['posts'] as $index => $post) 
	{
	?>
