...
if(isset($this->stats) && is_array($this->stats[$_stats_idx])) 
{
	$stats = $this->stats[$_stats_idx];
}
...
[data-v-component-stats] [data-v-stats-*]|innerText = $stats['@@__data-v-stats-([a-zA-Z_]+)__@@']
...
if($stats) {
	...
	@stat [data-v-stat-*]|innerText = $stat['@@__data-v-stat-([a-zA-Z_]+)__@@']
