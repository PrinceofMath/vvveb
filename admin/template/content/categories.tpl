...
?>
	...
	foreach($_categories as $id => $taxonomy_item) {
		...
		@taxonomy_item [data-v-taxonomy_item-*] = $taxonomy_item['@@__data-v-taxonomy_item-([a-zA-Z_]+)__@@']
...
?>
	...
	[data-v-languages] [data-v-language_id]|name = <?php echo "taxonomy_item_description[$language_id][language_id]";?>
	[data-v-languages] [data-v-language_id]|value = <?php echo $language_id;?>

	@language [data-v-language-lang-name]|innerText = <?php echo ucfirst($this->languagesList[$language_id]['name']);?>
	@language [data-v-language-*]|innerText = $taxonomy_item['languages'][$language_id]['@@__data-v-language-([a-zA-Z_]+)__@@']
	@language [data-v-language-*]|name = <?php echo "taxonomy_item_description[$language_id][@@__data-v-language-([a-zA-Z_]+)__@@]";?>
	@language input[data-v-language-*]|value = $taxonomy_item['languages'][$language_id]['@@__data-v-language-([a-zA-Z_]+)__@@']
