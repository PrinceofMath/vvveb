...
if(isset($this->menus) && is_array($this->menus)) {
	...
	[data-v-menus] [data-v-menu] [data-v-*]|innerText = $menu['@@__data-v-([a-zA-Z_]+)__@@']
	[data-v-menus] [data-v-menu] [data-v-*]|title = $menu['@@__data-v-([a-zA-Z_]+)__@@']
	...
	[data-v-menus] [data-v-menu] a[data-v-*]|href = $menu['@@__data-v-([a-zA-Z_-]+)__@@']	
