...
[data-v-taxonomy_id] = $this->menu_id
...
?>
	...
	foreach($_categories as $id => $menu) {
		...
		@menu [data-v-taxonomy_item-*] = $menu['@@__data-v-taxonomy_item-([a-zA-Z_]+)__@@']
...
?>
	...
	[data-v-languages] input[data-v-language_id]|name = <?php echo "menu_item_description[$language_id][language_id]";?>
	
	@language [data-v-language-lang-name]|innerText = <?php echo ucfirst($this->languagesList[$language_id]['name']);?>
	@language [data-v-language-*]|innerText = $menu['languages'][$language_id]['@@__data-v-language-([a-zA-Z_]+)__@@']
	@language [data-v-language-*]|name = <?php echo "menu_item_description[$language_id][@@__data-v-language-([a-zA-Z_]+)__@@]";?>
	@language input[data-v-language-*]|value = $menu['languages'][$language_id]['@@__data-v-language-([a-zA-Z_]+)__@@']
