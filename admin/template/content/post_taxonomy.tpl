...
if(isset($this->taxonomies) && is_array($this->taxonomies)) {
	...
	@taxonomy_item input[data-v-post-taxonomy_item-*]|value = $taxonomyItem['@@__data-v-post-taxonomy_item-([a-zA-Z_]+)__@@']
...
?>
	...
	foreach($_categories as $id => $taxonomyItem) {
		...
		@category [data-v-taxonomy_item-*] = $taxonomyItem['@@__data-v-taxonomy_item-([a-zA-Z_]+)__@@']
...
?>
	...
	foreach($_categories as $id => $taxonomyItem) {
		...
		//catch all data attributes
		@tag [data-v-taxonomy_item-*] = $taxonomyItem['@@__data-v-taxonomy_item-([a-zA-Z_]+)__@@']
