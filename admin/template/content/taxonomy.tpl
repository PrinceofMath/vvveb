...
if(isset($this->taxonomies) && is_array($this->taxonomies)) 
{
	...
	[data-v-taxonomies] [data-v-taxonomy_item] [data-v-*]|innerText = $taxonomy_item['@@__data-v-([a-zA-Z_]+)__@@']
	[data-v-taxonomies] [data-v-taxonomy_item] [data-v-*]|title = $taxonomy_item['@@__data-v-([a-zA-Z_]+)__@@']
