...
if(isset($this->sitesList) && is_array($this->sitesList)) {
	...
	[data-v-sites] [data-v-site] [data-v-*]|innerText = $site['@@__data-v-([a-zA-Z_]+)__@@']
	[data-v-sites] [data-v-site] [data-v-*]|title = $site['@@__data-v-([a-zA-Z_]+)__@@']

	[data-v-sites] [data-v-site] a[data-v-url]|href = <?php echo "//{$site['host']}";?>	
