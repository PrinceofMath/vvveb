...
if (isset($this->content_categories[$_categories_idx])) {
	$_pagination_count = $this->content_categories[$_categories_idx]['count'] ?? 0;
	//$_pagination_limit = $this->content_categories[$_categories_idx]['limit'];
	$_categories = $this->content_categories[$_categories_idx]['categories'] ?? [];
}
