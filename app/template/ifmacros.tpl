...
[data-v-if-not][data-v-if-not]|after = <?php } ?>


[data-v-if]|addClass = <?php if ($vvveb_is_page_edit && !$condition) echo 'vvveb-hidden'?>
[data-v-if-not]|addClass = <?php if ($vvveb_is_page_edit && !$condition) echo 'vvveb-hidden'?>
