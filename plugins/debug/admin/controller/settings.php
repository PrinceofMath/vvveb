...
namespace Vvveb\Plugins\Debug\Controller;
...
class Settings extends Base {
	...
	function index() {
		...
		return null;
		//insert plugin html
		$view->psttt->insertHTML('public/admin/theme/default/content/fields.html', 'plugins/test/public/admin/content/fields.article.html', [
			//headcolumn
			[
		...
		$view->psttt->addTemplate('public/admin/theme/default/content/fields.pst', 'plugins/test/admin/content/fields.pst');
	}
}
