...
class DebugPlugin {
	...
	function errorLog() {
		...
		$this->view->debug['data']['errorlog'] = $text ?? _('PHP error log not readable, make sure that your log is properly configured and that is readable.');
	}
	...
	function __construct() {
		...
		//when the request is finished and the templare render gather info
